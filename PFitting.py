...
class PFitting:
    ...
    def run_calibrations(self,df,QrHpScaleFtr):
        ...
        fig.update_layout(title='Reduced Power for Fitted Cases',xaxis_title='Reduced Flow (Qr)',yaxis_title='Reduced Power (Pr)',template='plotly_white',legend=dict(yanchor="middle", y=0.99, xanchor="right", x=0.99))
