...
st.title('Compressor Compressor Performance Maps Fitting Tool')
with st.sidebar:
                ...
                try:
                    ...
                    if export_rows:
                        ...
                        if compressor_type == "Centrifugal Compressor":
                            ...
                            idx_head = coefficients_df.index[coefficients_df['Variables'].eq('QrMinMaxHead')][0]
                            idx_power = coefficients_df.index[coefficients_df['Variables'].eq('QrMinMaxPower')][0]
                            ...
                            coefficients_df.rename(columns={'Variables':'CoefficientNames','HeadCurve':'HCoeff','PowerCurve':'PCoeff'},inplace=True)
